...
#define STRING_CONFIG_H_AUTHOR "Isaac W." // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_RADIUS 133.62

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 282.05             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.94, 0.0, -0.52 } // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.01, -0.39, 0.40 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 1391.04}  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -14.95}
